...
def send_login_email(email):
    ...
    send_email(_('Sign in to %(name)s', name=current_app.config['APP_NAME']),
               sender=(current_app.config['MAIL_SENDER_NAME'], current_app.config['MAIL_SENDER_EMAIL']),
               recipients=[email],
